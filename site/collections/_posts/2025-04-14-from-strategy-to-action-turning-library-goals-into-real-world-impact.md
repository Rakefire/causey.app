...
### The CAPE Cycle: A Practical Planning Framework

Mission Met’s **CAPE Cycle** offers a simple structure that libraries can adopt today:

* **Champion** – Appoint internal champions who consistently drive the plan forward.
* **Assess** – Gather input from patrons, staff, and stakeholders to understand where you are and where you want to go.
* **Plan** – Create focused goals with clear action steps.
* **Execute** – Commit to doing the work, evaluating progress, and celebrating success.
...
### Structuring a Plan That Drives Results
...
* A homepage event feed across all branches,
* Frictionless online registration with automated reminders,
* And a powerful digital resources page with filtering tools.

This made discovery easy and engagement higher.

#### 3\. **Maximizing Meeting Room Use**
